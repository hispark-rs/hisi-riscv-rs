//! HiSilicon BS20 LED Blinky example.
//!
...
//! is sized for the BS20 app core (64 MHz) rather than WS63's 240 MHz.
...
/// Approximate busy-wait delay (~64 cycles ≈ 1 µs at the 64 MHz BS20 CPU clock).
fn delay_ms(ms: u32) {
    for _ in 0..ms {
        for _ in 0..64_000 {
            core::hint::spin_loop();
...
fn main() -> ! {
    ...
    // SAFETY: GPIO0 is a valid BS20 pin (0..32) and this example owns it exclusively.
