/*
 * Memory layout for HiSilicon BS21 / BS2X (RV32IMFC, SparkLink/NearLink).
 *
 *   ROM:      0x000000 - 0x080000  (mask ROM; 32K MPU window, symbols to ~0x40000)
 *   ITCM:     0x080000 - 0x100000  (512K instruction TCM)
 *   L2RAM:    0x100000 - 0x128000  (160K main RAM — BS21E/BS22; BS20 is 128K)
