...
> QEMU 模型的原理见 [QEMU 模型](../../explanation/06-qemu-model.md)。
...
> 关于构建目标和产物路径的细节，见 [构建一个示例](../../how-to/02-build-example.md)。
...
> 各示例的预期标记串汇总见 [示例目录与验证标记串](../../reference/02-examples.md)；
> 半主机相关的环境变量见 [HIL 脚本与 runner 环境变量](../../reference/07-hil-markers.md)。
