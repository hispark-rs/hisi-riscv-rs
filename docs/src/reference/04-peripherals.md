...
`SYS_CTL0`、`SYS_CTL1`、`GLB_CTL_M`、`CLDO_CRG`、`IO_CONFIG`、`GPIO0`、`GPIO1`、`GPIO2`、`ULP_GPIO`、`UART0`、`UART1`、`UART2`、`I2C0`、`I2C1`、`SPI0`、`SPI1`、`PWM`、`I2S`、`LSADC`、`DMA`、`SDMA`、`SFC_CFG`、`TIMER`、`WDT`、`RTC`、`TCXO`、`TSENSOR`、`EFUSE`、`SPACC`、`PKE`、`KM`、`TRNG`、`RF_WB_CTL`、`SHARE_MEM_CTL`、`BT_EM_CTL`、`FAMA_REMAP`。
