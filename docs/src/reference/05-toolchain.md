...
安装步骤见 [安装 hisi-riscv 工具链](../how-to/01-install-toolchain.md)；硬浮点选型原理见 [硬浮点工具链](../explanation/03-hardfloat-toolchain.md)。
...
| `runner` | `gdb-multiarch` | `cargo run` 默认 runner（QEMU/真机 runner 经 env 覆盖，见 [硬件 runner](../how-to/06-hardware-runner.md)） |
