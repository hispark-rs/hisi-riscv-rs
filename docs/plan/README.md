...
|---|---|---:|---|---|
| [Connectivity 全栈](hisi-connectivity-stack.md) | 执行中 | P0 | A5、BLE B0-B3、SLE S0-S3 与 U0/U1 facade ownership 已闭合 | 当前唯一 WIP：U2 typed GAP/announce/seek |
...
flowchart LR
    ...
    U1 --> U2["NOW U2 typed GAP/announce/seek"]
```

这张图记录 A5、BLE B0-B3、SLE S0-S3 和 Radio UX U0/U1 已完成。历史 Wi-Fi 反例仍
保留为回归证据，但不再伪装成未完成门槛；当前 major WIP 只有 U2，不能把
