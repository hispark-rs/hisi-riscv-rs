...
bash .claude/skills/hil-regression/regression.sh

# Diagnose a specific run:
bash .claude/skills/hil-regression/regression.sh --run 28502888903

# Show pass/fail history for the last 30 days:
bash .claude/skills/hil-regression/regression.sh --history
```
