#!/usr/bin/env python3
"""Rebuild the SDK supplicant as a WPA2-Personal-only deterministic archive.

The SDK Ninja graph is the compiler-command oracle. This tool preserves its
compiler, ABI flags and include paths, but selects sources and feature defines
through wpa2-personal-profile.toml.
"""
...
def main() -> int:
    ...
    undef_header = build_dir / "wpa2-personal-undef.h"
