...
3. Rust 应用使用 `hisi-riscv-rt` 启动 + `hisi-hal` 驱动，在原厂 flashboot 跳转后接管。
...
架构与评审见 [`docs/src/explanation/components/08-ws63-flashboot.md`](../../../docs/src/explanation/components/08-ws63-flashboot.md)。
