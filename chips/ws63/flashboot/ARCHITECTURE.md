...
完整架构与评审（集中维护于主仓库）：
- 组件文档：<https://github.com/sanchuanhehe/hisi-riscv-rs/blob/main/docs/architecture/ws63-flashboot.md>
- 整改排期：<https://github.com/sanchuanhehe/hisi-riscv-rs/blob/main/ROADMAP.md>（阶段 2，若继续维护）
